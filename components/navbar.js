        ...
        >
            ...
            >
                ...
                <Stack
                    ...
                    mt={{ base: 4, md: 0 }}
                >
                    <LinkItem href="https://github.com/btwkenji?tab=repositories" path={path}>
                        projects
                    </LinkItem>
                    <LinkItem href="https://t.me/btwkenji" path={path}>
                        contact
                    </LinkItem>
                    <LinkItem href="https://github.com/btwkenji" path={path}>
                        github
                    </LinkItem>
                ...
                <Box flex={1} align="right">
                    ...
                    <Box ml={2} display={{ base: "inline-block", md: "none" }}>
                        <Menu isLazy id="navbar-menu">
                            ...
                            />
                            <MenuList>
                                <MenuItem as={MenuLink} href="https://github.com/btwkenji?tab=repositories">
                                    projects
                                </MenuItem>
                                <MenuItem as={MenuLink} href="https://t.me/btwkenji">
                                    contact
                                </MenuItem>
                                <MenuItem
                                    as={MenuLink}
